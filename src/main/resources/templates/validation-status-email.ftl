...
<body lang="EN-US" link="#467886" vlink="#96607D"
	...
	<div class="WordSection1">
		<p class="MsoNormal">
			<span style="font-family: 'Calibri', sans-serif">Hi All,<o:p></o:p>
			</span>
		</p>
		<p class="MsoNormal">
		...
		<p class="MsoNormal">
			<span style="font-family: 'Calibri', sans-serif">The WCW
				Certification feed for ${date} <span><b>${isFaulty}</b></span>${reason}
				and <b>${text}.</b> <br> Hence, the file ${actionDone} to the
				300/301 server through the bamboo plan.<o:p></o:p>
			</span>
		</p>
		<p class=MsoNormal>
			<span style='mso-bookmark: _MailOriginal'><span
				style='font-family: "Calibri", sans-serif; mso-bidi-font-family: "Times New Roman"; mso-bidi-theme-font: minor-bidi'><o:p>&nbsp;</o:p></span></span>
		</p>
		...
		<p class=MsoNormal>
			<span style='mso-bookmark: _MailOriginal'><b><span
					style='font-family: "Calibri", sans-serif; mso-bidi-font-family: "Times New Roman"; mso-bidi-theme-font: minor-bidi'><o:p>&nbsp;</o:p></span></b></span>
		</p>
		...
		<p class="MsoNormal">
			<span
				style="font-family: 'Calibri', sans-serif; background-color: yellow;"><b>Note:</b>
				This email was automatically generated. Please do not reply to this.
			</span>
			<o:p></o:p>
		</p>
	</div>
